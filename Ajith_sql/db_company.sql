...
-- use company;
-- create table jobs(job_id int ,job_title varchar(50) ,min_salary int ,max_salary int,primary key(job_id));
-- create table region(region_id int not null, region_name varchar(50), primary key(region_id));
 -- create table country(country_id varchar(20) not null, country_name varchar(50),
 -- region_id int,
 -- primary key(country_id),
 -- foreign key(region_id) references region(region_id));
 -- create table locations(location_id int,street_address varchar(50),postal_code varchar(20),city varchar(20),state_province varchar(30),
 -- country_id varchar(20),primary key(location_id),
 ...
 -- create table employee(employee_id int,first_name varchar(20),last_name varchar(20),email varchar(30),
 -- phone_number varchar(15),hire_date date, salary int,manager_id int,job_id int,department_id int,
 -- primary key(employee_id),foreign key(job_id) references jobs(job_id),
 -- foreign key(department_id) references departments(department_id));
 -- create table dependents(dependent_id varchar(20),first_name varchar(20),last_name varchar(10),relationship varchar(20),employee_id int,
 -- primary key(dependent_id),foreign key(employee_id) references employee(employee_id));
 -- alter table departments rename to dept;
 -- alter table employee add constraint foreign key(manager_id) references employee(employee_id);
...
-- INSERT INTO jobs(job_id,job_title,min_salary,max_salary) VALUES(5,'AdministrationVicePresident',15000.00,30000.00);
-- INSERT INTO jobs(job_id,job_title,min_salary,max_salary) VALUES (6,'Accountant',4200.00,9000.00);
-- INSERT INTO jobs(job_id,job_title,min_salary,max_salary) VALUES(7,'Finance Manager',8200.00,16000.00);
-- INSERT INTO jobs(job_id,job_title,min_salary,max_salary) VALUES(8,'Human ResourceRepresentative',4000.00,9000.00);
...
-- INSERT INTO jobs(job_id,job_title,min_salary,max_salary) VALUES(12,'PublicRelationsRepresentative',4500.00,10500.00);
...
-- INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES
-- (103,'Alexander','Hunold','alex.old@sqltutorial.org','590.423.4567','1990-01-03',9,9000.00,102,6);
-- INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES
...
-- INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES
-- (106,'Valli','Pataballa','pataballa@sqltutorial.org','590.423.4560','1998-02-05',9,4800.00,103,6);
-- INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES
-- (107,'Diana','Lorentz','diana@sqltutorial.org','590.423.5567','1999-02-07',9,4200.00,103,6);
-- INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES
-- (108,'Nancy','Greenberg','nancy@sqltutorial.org','515.124.4569','1994-08-17',7,12000.00,101,10);
-- INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES
...
-- INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES 
-- (112,'JoseManuel','Urman','jose.urman@sqltutorial.org','515.124.4469','1998-03-07',6,7800.00,108,10);
-- INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES
-- (113,'Luis','Popp','luis.@sqltutorial.org','515.124.4567','1999-12-07',6,6900.00,108,10);
-- INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES
-- (114,'Den','Raphaely','den.raphaely@sqltutorial.org','515.127.4561','1994-12-07',14,11000.00,100,3);
-- INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES
-- (115,'Alexander','Khoo','alex.khoo@sqltutorial.org','515.127.4562','1995-05-18',13,3100.00,114,3);
-- INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES
-- (116,'Shelli','Baida','shelli.ba@sqltutorial.org','515.127.4563','1997-12-24',13,2900.00,114,3); 
-- INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES
-- (117,'Sigal','Tobias','sigal.tobs@sqltutorial.org','515.127.4564','1997-07-24',13,2800.00,114,3);
-- INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES
-- (118,'Guy','Himuro','guy@sqltutorial.org','515.127.4565','1998-11-15',13,2600.00,114,3);
-- INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES
-- (119,'Karen','Colmenares','karen.cols@sqltutorial.org','515.127.4566','1999-08-10',13,2500.00,114,3);
-- INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES
-- (120,'Matthew','Weiss','matthew.w@sqltutorial.org','650.123.1234','1996-07-18',19,8000.00,100,5);
-- INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES
-- (121,'Adam','Fripp','adam.f@sqltutorial.org','650.123.2234','1997-04-10',19,8200.00,100,5);
-- INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES
-- (122,'Payam','Kaufling','payam.k@sqltutorial.org','650.123.3234','1995-05-01',19,7900.00,100,5); 
-- INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES
-- (123,'Shanta','Vollman','shanta.voll@sqltutorial.org','650.123.4234','1997-10-10',19,6500.00,100,5);
-- INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES
-- (126,'Irene','Mikkilineni','irene.mik@sqltutorial.org','650.124.1224','1998-09-28',18,2700.00,120,5);
-- INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES
-- (145,'John','Russell','john.@sqltuorial.org',NULL,'1996-10-01',15,14000.00,100,8);
-- INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES
-- (146,'Karen','Partners','karen@sqltutorial.org',NULL,'1997-01-05',15,13500.00,100,8);
-- INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES
-- (176,'Jonathon','Taylor','jonathon@sqltutorial.org',NULL,'1998-03-24',16,8600.00,100,8);
-- INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES
-- (177,'Jack','Livingston','jack.liv@sqltutorial.org',NULL,'1998-04-23',16,8400.00,100,8); 
-- INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES
-- (178,'Kimberely','Grant','kimbere@sqltutorial.org',NULL,'1999-05-24',16,7000.00,100,8);
-- INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES
-- (179,'Charles','Johnson','charles.j@sqltutorial.org',NULL,'2000-01-04',16,6200.00,100,8);
-- INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES
-- (192,'Sarah','Bell','sarah.bell@sqltutorial.org','650.501.1876','1996-02-04',17,4000.00,123,5);
-- INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES
-- (193,'Britney','Everett','britney@sqltutorial.org','650.501.2876','1997-03-03',17,3900.00,123,5);
-- INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES
-- (200,'Jennifer','Whalen','jennifer@sqltutorial.org','515.123.4444','1987-09-17',3,4400.00,101,1);
-- INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES
-- (201,'Michael','Hartstein','michael.h@sqltutorial.org','515.123.5555','1996-02-17',10,13000.00,100,2); 
-- INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES
...
-- INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES
-- (204,'Hermann','Baer','herm.baer@sqltutorial.org','515.123.8888','1994-06-07',12,10000.00,101,7);
-- INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES
-- (205,'Shelley','Higgins','shelley.hig@sqltutorial.org','515.123.8080','1994-06-07',2,12000.00,101,11);
-- INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES
-- (206,'William','Gietz','will.gietz@sqltutorial.org','515.123.8181','1994-06-07',1,8300.00,205,11);
-- INSERT INTO
